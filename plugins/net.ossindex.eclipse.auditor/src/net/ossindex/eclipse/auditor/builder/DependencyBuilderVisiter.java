...
import net.ossindex.eclipse.auditor.Activator;
import net.ossindex.eclipse.auditor.builder.depends.IDependencyEvent;
import net.ossindex.eclipse.auditor.builder.depends.IDependencyListener;
import net.ossindex.eclipse.auditor.builder.depends.IDependencyPlugin;
...
{
	public static final String DEPENDENCY_NAME = "net.ossindex.eclipse.auditor.marker.name";
	public static final String DEPENDENCY_VERSION = "net.ossindex.eclipse.auditor.marker.version";
	public static final String DEPENDENCY_OPTIONAL = "net.ossindex.eclipse.auditor.marker.optional";
	public static final String DEPENDENCY_MARKER = "net.ossindex.eclipse.auditor.marker.DependencyMarker";
	public static final String ROOT_DEPENDENCY_MARKER = "net.ossindex.eclipse.auditor.marker.RootDependencyMarker";
	public static final String OPTIONAL_DEPENDENCY_MARKER = "net.ossindex.eclipse.auditor.marker.OptionalDependencyMarker";
	public static final String WARNING_DEPENDENCY_MARKER = "net.ossindex.eclipse.auditor.marker.WarningDependencyMarker";
	public static final String DEPENDENCY_URL = "net.ossindex.eclipse.auditor.marker.url";
	public static final String DEPENDENCY_ARTIFACT = "net.ossindex.eclipse.auditor.marker.artifactId";
	public static final String DEPENDENCY_SCM = "net.ossindex.eclipse.auditor.marker.scmId";
	
	public static final String VULNERABILITY_ID = "net.ossindex.eclipse.auditor.marker.id";
	public static final String VULNERABILITY_MARKER = "net.ossindex.eclipse.auditor.marker.VulnerabilityMarker";
	public static final String VULNERABILITY_SUMMARY = "net.ossindex.eclipse.auditor.marker.summary";
